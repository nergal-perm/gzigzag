...
import org.gzigzag.media.SpanSet;
...
// XXX These should be made garbage collectable ASAP!
    ...
    public Hashtable getSpaceParts() {
        return spaceParts;
    }
    ...
    public ZZObsTrigger getTextTrig() {
        return textTrig;
    }
    ...
    // XXX posConnections()?
    public ZZCell[] findLongRankHeads(String dim) {
        return null;
    }
