...
public class Expression {
    ...
    public Expression(ZZCell main) {
        if (main.s("d.expression", -1)!=null)
            throw new ZZError("Tried to create Expression from a cell which " + "is not headcell on d.expression! Cell: " + main);
        this.main = main;
    }
     ...
     * This looks up the specified param and connects a new expression to it.
     *
     * @param fn The function to put at the center of the new expression.
     */
    ...
    public ZZCell getParam(String dim) {
        return getParam(dim, 1);
    }
