/* DO NOT EDIT THIS FILE. THIS FILE WAS GENERATED FROM flob/SimpleFlobView.zob,
...
public class SimpleFlobView implements FlobView, ZOb {
    ...
    private int readParams(ZZCell start, int mask) {
        ...
        while (n!=null) {
            ...
            } else if (s.equals("decorator")) {
                mask |= 2;
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    {
                        decorator = ZZDefaultSpace.readZOb(c);
                        // decorator = ZZDefaultSpace.newZOb(s);
                        // decorator.readParams(c.s("d.2"));
    ...
    public void raster(FlobSet into, FlobFactory fact,
        ...
        x.findZoom(zl);
        x.setFinalRange(0, size.width);
        y.findZoom(zl);
        y.setFinalRange(0, size.height);
