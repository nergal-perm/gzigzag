        ...
        while (n!=null) {
            ...
            if (s.equals("horizonlevel")) {
                ...
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    horizonlevel = (Float.valueOf(s)).floatValue();
                } catch (Exception e) {
                    ZZLogger.exc(e);
                }
            } else if (s.equals("pointerradius")) {
                mask |= 2;
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    pointerradius = (Float.valueOf(s)).floatValue();
                } catch (Exception e) {
                    ZZLogger.exc(e);
                }
            } else if (s.equals("sizefactor")) {
                mask |= 4;
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    sizefactor = (Float.valueOf(s)).floatValue();
                } catch (Exception e) {
                    ZZLogger.exc(e);
                }
            } else if (s.equals("initdepth")) {
                mask |= 8;
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    initdepth = Integer.parseInt(s);
                } catch (Exception e) {
                    ZZLogger.exc(e);
                }
            ...
            } else if (s.equals("linecolor")) {
                mask |= 32;
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    linecolor = Color.decode(s);
                } catch (Exception e) {
                    ZZLogger.exc(e);
                }
            } else if (s.equals("arrowhead_angle")) {
                mask |= 64;
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    arrowhead_angle = (Double.valueOf(s)).doubleValue();
                } catch (Exception e) {
                    ZZLogger.exc(e);
                }
            } else if (s.equals("arrowhead_length")) {
                mask |= 128;
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    arrowhead_length = Integer.parseInt(s);
                } catch (Exception e) {
                    ZZLogger.exc(e);
                }
            } else {
