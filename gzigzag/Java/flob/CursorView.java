/* DO NOT EDIT THIS FILE. THIS FILE WAS GENERATED FROM flob/CursorView.zob,
 ...
 * <p>Default value: <PRE> (float) 0.5;</PRE>. 
 ...
 */ 
 ...
 public 
        float horizonlevel
            = (float) 0.5;/** UNDOCUMENTED. 
 
 * <p>Default value: <PRE> (float) 0.3;</PRE>. 
 
 * @structparam 1 
 */ 

 public         float pointerradius
            = (float) 0.3;/** UNDOCUMENTED. 
 
 * <p>Default value: <PRE> (float) 0.8;</PRE>. 
 
 * @structparam 1 
 */ 

 public         float sizefactor
            = (float) 0.8;/** UNDOCUMENTED. 
 
 * <p>Default value: <PRE> 2;</PRE>. 
 ...
 * <p>Default value: <PRE> Color.blue;</PRE>. 
 
 * @structparam 1 
 */ 

 public         Color linecolor
            = Color.blue;/** UNDOCUMENTED. 
 
 * <p>Default value: <PRE> Math.PI / 6;</PRE>. 
 
 * @structparam 1 
 */ 

 public         double arrowhead_angle
            = Math.PI / 6;/** UNDOCUMENTED. 
 ...
 */ 
 ...
 public         int arrowhead_length
	...
	while(n != null) {
	    ...
	    if(s.equals("horizonlevel")) {
		mask |= 1;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); horizonlevel = (Float.valueOf(s)).floatValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
	    ...
	    if(s.equals("pointerradius")) {
		mask |= 2;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); pointerradius = (Float.valueOf(s)).floatValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
	    ...
	    if(s.equals("sizefactor")) {
		mask |= 4;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); sizefactor = (Float.valueOf(s)).floatValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
	    ...
	    if(s.equals("initdepth")) {
		mask |= 8;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); initdepth = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 16;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); maxdepth = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
	    ...
	    if(s.equals("linecolor")) {
		mask |= 32;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); linecolor = Color.decode(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
	    ...
	    if(s.equals("arrowhead_angle")) {
		mask |= 64;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); arrowhead_angle = (Double.valueOf(s)).doubleValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
	    ...
	    if(s.equals("arrowhead_length")) {
		mask |= 128;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); arrowhead_length = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
