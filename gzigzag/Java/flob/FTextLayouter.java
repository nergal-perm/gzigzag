/* DO NOT EDIT THIS FILE. THIS FILE WAS GENERATED FROM flob/FTextLayouter.zob,
...
public class FTextLayouter implements ZOb {
    ...
    public FTextLayouter(boolean firstCap) {
        ...
        while (n!=null) {
            ...
            if (s.equals("firstCap")) {
                ...
                try {
                    ZZCell c = n.s("d.1");
                    s = c.getText();
                    if (s.equals("true")) firstCap = true;
                    else if (s.equals("false")) firstCap = false;
                    else { /* XXX ??? */ }
