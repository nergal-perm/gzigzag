 ...
 */ 
 ...
 public 
	float[] shrink // 2..2
	    = new float[] {(float)0.9, (float)0.9}; 	/** The factor the center cell is enlarged with from default.
 ...
 */ 
 ...
 public 
	float[] initmul // 2..2
	    = new float[] {(float)1.6, (float)1.6};	/** The factor to enlarge the center cell on top of initmul.
 ...
 */ 
 ...
 public 
	float[] centermul // 2..2
	    = new float[] {(float)1.0, (float)1.0};	/** The distance between neighbouring cells.
 ...
 */ 
 ...
 public 
	int[] gap // 2..2
	    = new int[] {5, 5};	/** The depth to raster to.
 ...
 */ 
 ...
 public 
	int depth 
	    = 5;	/** The precedence order of dimensions.
 ...
 */ 
 ...
 public 
	int[] pref // 2..5
	    = new int[] {0, 1, 2};	/** Whether to allow cell sizes to vary.
 ...
 */ 
 ...
 public 
	boolean varsize
	    = false;	/** Whether alignment around visual flob center is to be used.
 ...
 */ 
 ...
 public 
	boolean centeralign
	    = true;	/** Distance reverse perspective.
 ...
 */ 
 ...
 public 
	float revper
	    = (float)1.00;	/** Horizontal alignment. 
 ...
 */ 
 ...
 public 
	...
	while(n != null) {
		...
		mask |= 16;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); depth = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 256;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); revper = (Float.valueOf(s)).floatValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 512;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); halign = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
