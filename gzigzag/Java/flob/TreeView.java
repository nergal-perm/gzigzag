 ...
 */ 
 ...
 public 
        float initmul
            = (float)1.6;        /** How many recursion levels shall we render (half up, half
            down depthwise)? 
 ...
 */ 
 ...
 public 
        int maxdepth
            = 4;        /** The distance between neigbouring cells.
 ...
 */ 
 ...
 public 
        int[] gap // 2..2
            = new int[] {3, 6};        /** The factor of enlargement of cells as they move away
 ...
 */ 
 ...
 public 
        float[] shrink
            = new float[] {(float) 0.7, (float) 0.8};        /** Should the tree lines be drawn at all? 
 ...
 */ 
 ...
 public 
        boolean treelines
            = true;        /** Should the tree be shown "depthhorizontal", ie. depth rightwards? 
