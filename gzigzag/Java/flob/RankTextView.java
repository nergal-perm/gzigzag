 ...
 */ 
 ...
 public 
	int width
	    = 300;	/** The font for the maximal line.  
 ...
 */ 
 ...
 public 
	ScalableFont font
	    = new ScalableFont("SansSerif", Font.PLAIN, 16);	/** The half-width of the bulge. 
 ...
 */ 
 ...
 public 
	String dim
	    = "d.2";	/** Whether to billow the text. 
 * <p>Default value: <PRE> true;</PRE>. 
 ...
 */ 
 ...
 public 
	boolean billow
	    = true;	/** Whether to show XOR cursors. 
 * <p>Default value: <PRE> true;</PRE>. 
 ...
 */ 
 ...
 public 
	boolean xor
	    = true;        /** The backround colour for all flobs (or null if determined
            from the cursors. 
 ...
 */ 
 ...
 public 
	...
	while(n != null) {
		...
		mask |= 1;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); width = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 4;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); bulge = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 16;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); dim = s;  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 128;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); bgcolor = Color.decode(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
