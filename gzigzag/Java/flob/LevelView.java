 ...
 */ 
 ...
 public 
        float initmul
            = (float)1.6;        /** How many recursion levels shall we render (on both sides of the
	  * root)? 
 ...
 */ 
 ...
 public 
        int maxdepth
            = 4;        /** The breadth distance between neigbouring cells. 
 ...
 */ 
 ...
 public 
        int bgap
            = 15;	/** The depth distance between a cell and a link 
 ...
 */ 
 ...
 public 
	int dgap
	    = 10;        /** The factor of enlargement of cells as they move away
 ...
 */ 
 ...
 public 
        float shrink
            = (float)0.7;	/** The enlargement factor applied to link cells. Think linkshrink! 
 ...
 */ 
 ...
 public 
	float linkshrink
	    = (float)0.25;        /** Should the tree be shown "depthhorizontal", ie. depth rightwards? 
 ...
 */ 
 ...
 public 
        boolean depthhorizontal
            = false;	/** Should the headcell be used on both dimensions?
 ...
 */ 
 ...
 public 
	boolean bothhead
	    = false;	/** Are links without targets interpreted as targets?
 ...
 */ 
 ...
 public 
	...
	while(n != null) {
		...
		mask |= 4;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); bgap = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 8;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); dgap = Integer.parseInt(s);  
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
		...
		mask |= 16;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); shrink = (Float.valueOf(s)).floatValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
	    ...
	    if(s.equals("linkshrink")) {
		mask |= 32;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); linkshrink = (Float.valueOf(s)).floatValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
