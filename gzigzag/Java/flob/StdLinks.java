 ...
 */ 
 ...
 public 
    float splinvec
	= 50;    /** Whether the tight-brick mode is used for cells with 
     * non-shown links.
 ...
 */ 
 ...
 public 
	...
	= false;    /** Whether to draw the links the old way, between corners.
 ...
 */ 
 ...
 public 
	...
	while(n != null) {
	    ...
	    if(s.equals("splinvec")) {
		mask |= 2;
		try {
		    ZZCell c = n.s("d.1"); s = c.getText(); splinvec = (Float.valueOf(s)).floatValue(); 
		} catch(Exception e) {
		    ZZLogger.exc(e);
		}
	    } else
