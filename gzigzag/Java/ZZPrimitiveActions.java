...
import org.gzigzag.clang.heraclitus.HeraclitusClang;
import org.gzigzag.errors.ZZError;
import org.gzigzag.flob.Flob;
import org.gzigzag.flob.FlobSet;
    ...
    public void execCallback(ZZCell code,
        ...
        synchronized (code.getSpace()) {
            ...
            if (toks[0].equals("NEW") ||
                ...
                try {
                    p("Enter heraclitus: ");
                    HeraclitusClang.execute(hc, curspar);
                    p("Exit heraclitus");
                } finally {
                ...
                dontStamp = true;
            } else if (toks[0].equals("CTXTSOL")) {  // SOL = start of line
                if (EditCursor.getOffs(view)==EditCursor.NO_OFFSET) return;
