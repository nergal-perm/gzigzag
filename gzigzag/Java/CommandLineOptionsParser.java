...
class CommandLineOptionsParser {
    ...
    public static class HelpOption extends Option {
         ...
         *         newlines are honoured.
         */
        public HelpOption(String name, String helpText, boolean exitAfter, String prologue, String epilogue) {
        ...
        public void action(CommandLineOptionsParser clop, String[] args) {
            ...
            for (Enumeration e = clop.options_in_order.elements(); e.hasMoreElements(); ) {
                Option opt = (Option) e.nextElement();
                int expltab = 15;
                int nametab = 3;
                int seplen = 2;
                String help = breakToLines(opt.helpText, rightmargin, expltab + nametab + seplen);
                ...
                if (name.length() > expltab) {
                    ...
                    help = spaces(nametab) + name + spaces(seplen + expltab - name.length()) + help.substring(expltab + nametab + seplen);
                }
        ...
        private String breakToLines(String s, int rmargin, int indent) {
            ...
            while (a < s.length()) {
                ...
                sb.append('\n');
                if (b < s.length() && (s.charAt(b)=='\n' || s.charAt(b)==' ' || s.charAt(b)=='\t')) {
                    ++b;
                }
                a = b;
            }
     ...
     * @see HelpOption
     */
    public void putHelp(String name, String helpText, boolean exitAfter, String prologue, String epilogue) {
