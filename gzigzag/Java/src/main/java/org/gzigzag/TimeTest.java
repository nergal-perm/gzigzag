...
public class TimeTest {
    ...
    public static void test(ZZSpace[] sp, Test[] tsts, boolean warmup) throws Exception {
        p("Testing...");
    ...
    public static void main(String[] argv) {
        try {
            ...
            ZZSpace spaces[] = new ZZSpace[]{new ZZCacheDimSpace(new DirStreamSet(f1)),};
            for (int i = 0; i < spaces.length; i++)
                ZZDefaultSpace.create(spaces[i].getHomeCell());

            Test[] tsts = new Test[]{newtest, instest, neigh1test, neigh2test, cont1test, cont2test, delneightest};
