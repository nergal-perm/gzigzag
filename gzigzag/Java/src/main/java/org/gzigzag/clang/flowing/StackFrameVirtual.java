...
public class StackFrameVirtual extends StackFrame {
    ...
    public StackFrameVirtual(StackFrameVirtual frame) {
        caller = frame;
    }
    ...
    public ZZCell getPos() {
        return called==null ? pos:called.getPos();
    }
    ...
    public StackFrame call() {
        return called = new StackFrameVirtual(this);
    }
    ...
    public boolean equals(StackFrameVirtual frame) {
        return this==frame;
    }
}
