/* DO NOT EDIT THIS FILE. THIS FILE WAS GENERATED FROM flob/ParallelTextView.zob,
...
public class ParallelTextView implements FlobView, ZOb {
    ...
    public void raster(FlobSet into, FlobFactory fact, ZZCell view, final String[] dims, ZZCell accursed) {
        ...
        ZZCell[] streams = new ZZCell[]{accursed.s(dims[0], -1), accursed, accursed.s(dims[0], 1),};
