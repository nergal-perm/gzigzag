...
public class CellFlobFactory2 implements FlobFactory, ZOb {
    ...
    public int[] margins = new int[]{3, 2};
    /**
     * UNDOCUMENTED.
     *
    ...
    public Flob makeFlob(FlobSet into, ZZCell c, ZZCell handleCell, float fract, int x, int y, int d, int w, int h) {
        ...
        FText ftxt = new FText(new FText.Part[]{new FText.CellPart(c, 0, -1, f, fm, null, null)});
...
//	    }
        ...
        if (f.c.s("d.mark-set", 1)!=null) f.addColor(Color.red);

        if (f.c.s("d.clone", -1)!=null) f.addColor(Color.yellow);
        else if (f.c.s("d.clone", 1)!=null) f.addColor(new Color(255, 255, 192));
