...
public class ZZCanvasView extends ZZViewComponent {
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        if ((ob!=null && !ob.equals(prevob)) || (prevob!=null && !prevob.equals(ob))) {
            prevx = e.getX();
            prevy = e.getY();
            prevob = ob;
            upd(e);
	...
	*/
	    ...
	    */
            ...
            if (modec!=null) {
                if (modec.getText().equals("CURSOR")) bg = ZZCursorReal.getColorOrWhite(viewCell);
                else bg = new java.awt.Color(Integer.parseInt(modec.getText()));
            }
            gr.setColor(bg);
            Insets ins = getInsets();
            gr.fillRect(ins.left, ins.top, thisd.width - ins.left - ins.right, thisd.height - ins.top - ins.bottom);
