...
public class StackFrameReal extends StackFrame {
    ...
    public StackFrameReal(ZZSpace sp) {
        main = sp.getHomeCell().N();
    }

    public StackFrameReal(ZZCell main) {
        this.main = main;
    }
    ...
    public ZZCell getPos() {
        return ZZCursorReal.get(main.h("d.2"));
    }

    public void setPos(ZZCell c) {
        ZZCursorReal.setcursor(main, c);
    }

    public StackFrame call() {
        return new StackFrameReal(this);
    }
    ...
    public boolean equals(StackFrameReal f) {
        return main.equals(f.main);
    }
}