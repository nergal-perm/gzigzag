...
public class ZZDefaultSpace {
    ...
    static class ZP {
        class StrCell {
            ...
            StrCell(String name, ZZCell val) {
                this.name = name;
                this.val = val;
            }
        }
    ...
    public static ZOb newZOb(String id) {
        ...
        if (ind==-1) {
            try {
                return (ZOb) Class.forName("org.gzigzag.flob." + id).newInstance();
            } catch (Exception e) {
                ZZLogger.exc(e);
                return null;
            }
