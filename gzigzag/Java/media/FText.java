...
import org.gzigzag.flob.Renderable;
import org.gzigzag.flob.SplitCellFlob1;
import org.gzigzag.flob.TextDecor;
...
public class FText {
    ...
    public static abstract class Part {
        ...
        public Part[] split(int at) {
            return new Part[]{to(at), from(at)};
        }

        public Part to(int at) {
            return subpart(0, at);
        }

        public Part from(int at) {
            return subpart(at, n);
        }
        ...
        public int getHitX(int x) {
            return getStrX(getHit(x));
        }
    ...
    public String get(int at, int n) {
        return get().substring(at, at + n);
    }
